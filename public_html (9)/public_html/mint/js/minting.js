...
var contractAddress = "0x1476EB6581AC72feA8191f5DFfCd274F6F32e588";
...
$('#single-price').html("<span>" + parseFloat(web3.utils.fromWei(singlePrice)) + " MATIC</span>")
$('#totalPrice').html("<span>" + totalPrice + " MATIC</span>");
}
